 ...
 * @author medas
 */
public class GroceriesAnalyticsReportsJPanel extends javax.swing.JPanel {
    ...
    public GroceriesAnalyticsReportsJPanel(JPanel userProcessContainer, EcoSystem system, String netowrkName) {
        initComponents();
        this.system = system;
        this.userProcessContainer = userProcessContainer;
        populateEmployeeCountGraph(netowrkName);
        populateFundsGraph(netowrkName);
    }
